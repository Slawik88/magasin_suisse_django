    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_main_image', models.ImageField(help_text='Завантажте зображення для товару', upload_to='images/product_main_image/%Y/%m/%d/', verbose_name='Зображення 1')),
                ('product_image_1', models.ImageField(help_text='Додаткове зображення до товару', upload_to='images/product_main_image/%Y/%m/%d/', verbose_name='Зображення 2')),
                ('product_image_2', models.ImageField(help_text='Додаткове зображення до товару', upload_to='images/product_main_image/%Y/%m/%d/', verbose_name='Зображення 4')),
                ('product_image_3', models.ImageField(help_text='Додаткове зображення до товару', upload_to='images/product_main_image/%Y/%m/%d/', verbose_name='Зображення 5')),
                ('product_image_4', models.ImageField(help_text='Додаткове зображення до товару', upload_to='images/product_main_image/%Y/%m/%d/', verbose_name='Зображення 6')),
                ('product_image54', models.ImageField(help_text='Додаткове зображення до товару', upload_to='images/product_main_image/%Y/%m/%d/', verbose_name='Зображення 7')),
                ('product_image_6', models.ImageField(help_text='Додаткове зображення до товару', upload_to='images/product_main_image/%Y/%m/%d/', verbose_name='Зображення 8')),
